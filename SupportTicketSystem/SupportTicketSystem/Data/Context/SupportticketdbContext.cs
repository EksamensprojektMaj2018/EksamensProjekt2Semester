...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=Server=tcp:supportticketdb.database.windows.net,1433;Initial Catalog=SupportTicketDB;Persist Security Info=True;User ID=Hasan;Password=Basri123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
